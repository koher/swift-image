extension Image where Pixel == RGBA<Int> { // map
    ...
    public func map(_ transform: (RGBA<Int>) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Int>) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Int>) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Int>) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Int>) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Int>) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Int>) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == RGBA<Float> { // map
    ...
    public func map(_ transform: (RGBA<Float>) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Float>) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Float>) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Float>) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Float>) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Float>) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Float>) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == RGBA<Double> { // map
    ...
    public func map(_ transform: (RGBA<Double>) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Double>) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Double>) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Double>) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Double>) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (RGBA<Double>) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (RGBA<Double>) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == Int { // map
    ...
    public func map(_ transform: (Int) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (Int) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Int) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Int) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (Int) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (Int) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
...
extension Image where Pixel == Float { // map
    ...
    public func map(_ transform: (Float) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (Float) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Float) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Float) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (Float) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (Float) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
...
extension Image where Pixel == Double { // map
    ...
    public func map(_ transform: (Double) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (Double) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Double) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Double) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (Double) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (Double) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (Double) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == RGBA<Int> { // map with indices
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Int>) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == RGBA<Float> { // map with indices
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Float>) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == RGBA<Double> { // map with indices
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: RGBA<Double>) -> Float) -> Image<Float> {
        return self._map(transform)
    }
...
extension Image where Pixel == Int { // map with indices
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Int) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Int) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Int) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Int) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Int) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Int) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
...
extension Image where Pixel == Float { // map with indices
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Float) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Float) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Float) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Float) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Float) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Float) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
...
extension Image where Pixel == Double { // map with indices
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> RGBA<UInt16>) -> Image<RGBA<UInt16>> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> RGBA<UInt32>) -> Image<RGBA<UInt32>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> RGBA<Float>) -> Image<RGBA<Float>> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> UInt8) -> Image<UInt8> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> UInt16) -> Image<UInt16> {
        return self._map(transform)
    }

    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> UInt32) -> Image<UInt32> {
        return self._map(transform)
    }
    ...
    public func map(_ transform: (_ x: Int, _ y: Int, _ pixel: Double) -> Float) -> Image<Float> {
        return self._map(transform)
    }
